...
VIEWPORT_SCALE = 1 / math.min(VIRTUAL_RESOLUTION_X / 430, VIRTUAL_RESOLUTION_Y / 242)
...
CELL_SIZE = 16
CELL_GRID_HEIGHT = math.ceil(242 / CELL_SIZE)
CELL_GRID_WIDTH = math.ceil(430 / CELL_SIZE)

CELL_TEXTURE_WIDTH = CELL_GRID_WIDTH
CELL_TEXTURE_HEIGHT = math.ceil(CELL_GRID_HEIGHT / 2)
